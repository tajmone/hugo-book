...
v1, 2018-10-04: Draft 144 -- Porting to AsciiDoc
:lang: en
:doctype: book
...
.Global Variables Defined by the Hugo Engine
...
* _Finally, if we've defined ``USE_PLURAL_OBJECTS``,_{fn8} _call the appropriate initialization routine:_
+
[source,hugo]
-------------------------
...
// @EDITED XREF ADDED: (undocumented & waiting approval: Issue #22)
