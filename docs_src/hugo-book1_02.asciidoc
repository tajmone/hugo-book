...
// @TODO: Missing XRef: "II.c Data Types"
...
A routine can return any kind of value (listed shortly in _II.c Data Types_).
...
// @TODO: Missing XRef: "IX. THE GAME LOOP" (in footonote!)
...
For more elaboration on the execution pattern of a Hugo program, see _IX. THE GAME LOOP_.]
...
// @TODO: Missing XRef: "IV.e. Operators and Assignments" (in footnote!)

// @HUGO SYNTAX MOCKUP!
[listing, subs="+macros"]
--------------------------------------------------------------------------------
<some variable> = <some value>footnote:[The section _IV.e. Operators and Assignments_ goes into greater detail on assigning values to variables.]
--------------------------------------------------------------------------------
...
// @NOTE: Was "if the `/` were ", but must have been a typo, for it didn't make sense!
...
[NOTE]
================================================================================
We'll get to exactly what that `if...print...` business means in just a little bit in _IV.h Conditional Expressions and Program Flow_.
================================================================================
...
// @NOTE: Redundant! This was just mentioned a few paragraphs before..
