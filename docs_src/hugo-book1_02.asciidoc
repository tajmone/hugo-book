...
// @XREF ADD: "IX. THE GAME LOOP" (in footonote!)
...
// @XREF ADD: "IV.e. Operators and Assignments" (in footnote!)
...
// @TEXT: Redundant! This was just mentioned a few paragraphs before..
