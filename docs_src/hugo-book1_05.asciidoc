...
// @XREF ADD: "VIII.g Perform" (in footnote!)
:fn3: footnote:[The actual mechanics are described in _VIII.g Perform_.]
...
// @XREF ADD: "IX THE GAME LOOP" (in footnote!)
:fn5: footnote:[See _IX THE GAME LOOP_.]

// @XREF ADD: "VII.a Grammar Definition" (in footnote!)
:fn6: pass:q[footnote:[ \
...
// @HUGO SYNTAX: The highlighted block ignores indentation on the first line!
* {blank}
+
[source,hugo]
--------------------------------------------------------------------------------
...
Now, for bonus points for those who have looked ahead to <<hugo-book1_14#the_hugo_library>> to see what things like `when_open`, `contains_desc`, and `static` are for, how could the cabinet be converted into, say, a secret passage into another room?
