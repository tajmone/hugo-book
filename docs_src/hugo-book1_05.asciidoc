...
:fn3: footnote:[The actual mechanics are described in xref:hugo-book1_08#perform[].]
...
:fn5: footnote:[See xref:hugo-book1_09#the_game_loop[].]
...
See xref:hugo-book1_07#grammar_definition[].]]
