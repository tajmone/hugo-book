...
// @XREF ADD: "V.a Routines" (in footnote!)
:fn5: pass:q[footnote:[ \
"`Arguments`" are simply parameters passed to a routine at calling time. \
See _V.a Routines_.]]

// @XREF ADD: "VII.b The Parser" (in footnote!)
:fn6: pass:q[footnote:[The built-in engine variables `parse$` and `serial$` may be used in place of the dictionary entry address; see _VII.b The Parser_ for a description.]]
...
// @XREF ADD: (xref to section on sys calls)
...
// @TEXT: discrepancy between source and output:
